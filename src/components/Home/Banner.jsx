...
const Banner = () => {
    ...
    return (
        <div name="banner">
            <div className="container mx-auto md:py-20 lg:py-32 flex flex-col h-screen items-center justify-between px-4 md:flex-row gap-10">
                <div className="flex flex-col justify-center lg:h-full p-4 rounded-lg">
                    ...
                    <button className="group text-white text-lg w-fit px-6 py-3 my-2 flex items-center rounded-md bg-gradient-to-r from-cyan-500 to-blue-500">
