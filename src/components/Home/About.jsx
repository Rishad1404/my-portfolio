...
const About = () => {
    return (
        <div className="container mx-auto h-screen py-10" name='about' >
            <p className="text-center font-light mb-2">Get To Know More</p>
            <h2 className="text-6xl font-bold mb-20 text-center">About Me</h2>
            <div className="flex flex-col md:flex-row items-center justify-center p-6">
                <div className="w-full md:w-1/3 flex justify-center mb-6 md:mb-0">
                    <img
                        ...
                        alt="Profile"
                        className="w-48 h-48 md:w-96 md:h-96 rounded-full shadow-lg bg-slate-100 p-10"
                    />
                </div>
                <div className="w-full md:w-2/3 md:ml-6 text-center md:text-left border-2 p-10 rounded-2xl">
